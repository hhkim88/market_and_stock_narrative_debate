...
### 미반영 내러티브 지속가능성 평가
세 방향의 미반영 내러티브 각각에 대해 아래 두 가지를 평가하시오.

**📈 강세 미반영 내러티브**
- 지속 가능한 이유: [이 믿음이 3개월간 실제로 유지·강화될 수 있는 구조적 근거. 예: 공급 계약 고정, 규제 일정 확정, 기술 독점 등]
- 지속 불가능한 이유: [이 믿음이 무너질 수 있는 시나리오. 예: 경쟁사 진입, 수요 급감, 실적 미달, 매크로 충격 등]
- 지속가능성 점수: [1-10] / 붕괴 확률: [높음/중간/낮음]

**➡️ 중립 미반영 내러티브**
- 지속 가능한 이유: [불확실성이 3개월간 해소되지 않을 구조적 근거]
- 지속 불가능한 이유: [방향성이 한쪽으로 결정될 수 있는 시나리오]
- 지속가능성 점수: [1-10] / 방향 결정 확률: [높음/중간/낮음]

**📉 약세 미반영 내러티브**
- 지속 가능한 이유: [이 불신이 3개월간 실제로 현실화될 구조적 근거]
- 지속 불가능한 이유: [이 리스크가 과장됐거나 해소될 수 있는 시나리오]
- 지속가능성 점수: [1-10] / 붕괴 확률: [높음/중간/낮음]

**종합 판단:** 세 방향 중 미반영 내러티브가 가장 지속가능한 것은 [강세/중립/약세]이며, 그 이유는 [한 문장].

### 판정 이유
[왜 이 방향의 집단 믿음이 가장 강하게 확산될 것인가.
 내러티브 인과 사슬 완결성 + 정량 정합성 + 지속가능성 + 집단 확산 속도 함께 서술.]
